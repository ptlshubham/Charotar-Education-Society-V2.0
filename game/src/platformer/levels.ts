...
export const jungle: Level = {
  ...
  name: 'Jungle Run',
  theme: 'jungle',
  backdrop: 'scenes/scene-discovery.webp',
  token: 'islands/island-discovery.webp',
  zoneClass: 'zone-discovery',
  panel: 'panels/panel-discovery.webp',
  tickBudget: 3600,
...
export const desert: Level = {
  ...
  name: 'Dune Dash',
  theme: 'desert',
  backdrop: 'scenes/scene-science.webp',
  token: 'islands/island-science.webp',
  zoneClass: 'zone-science',
  panel: 'panels/panel-science.webp',
  tickBudget: 4500,
...
export const volcano: Level = {
  ...
  name: 'Ember Climb',
  theme: 'volcano',
  backdrop: 'scenes/scene-challenges.webp',
  token: 'islands/island-maths.webp',
  zoneClass: 'zone-challenges',
  panel: 'panels/panel-challenges.webp',
  tickBudget: 5400,
...
export const ice: Level = {
  ...
  name: 'Frost Trail',
  theme: 'ice',
  backdrop: 'scenes/scene-world.webp',
  token: 'islands/island-world.webp',
  zoneClass: 'zone-world',
  panel: 'panels/panel-world.webp',
  tickBudget: 5000,
...
export const castle: Level = {
  ...
  name: 'Castle Climb',
  theme: 'castle',
  backdrop: 'scenes/scene-brain.webp',
  token: 'islands/island-brain.webp',
  zoneClass: 'zone-brain',
  panel: 'panels/panel-brain.webp',
  tickBudget: 3600,
...
export const canopy: Level = {
  ...
  name: 'Canopy Dash',
  theme: 'canopy',
  backdrop: 'scenes/scene-knowledge.webp',
  token: 'islands/island-knowledge.webp',
  zoneClass: 'zone-knowledge',
  panel: 'panels/panel-knowledge.webp',
  tickBudget: 6200,
...
export const village: Level = {
  ...
  name: 'Circuit Run',
  theme: 'village',
  backdrop: 'scenes/scene-tech.webp',
  token: 'islands/island-tech.webp',
  zoneClass: 'zone-tech',
  panel: 'panels/panel-tech.webp',
  tickBudget: 6600,
