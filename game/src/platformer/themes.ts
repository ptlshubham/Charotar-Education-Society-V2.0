...
export const ARCADE_THEMES: Readonly<Record<ThemeId, ArcadeTheme>> = {
  jungle: {
    ...
    treasure: 'Emerald coins', hazard: 'Deep river', title: 'titles/title-discovery.png',
  ...
  desert: {
    ...
    treasure: 'Sun coins', hazard: 'Quicksand', title: 'titles/title-science.png',
  ...
  volcano: {
    ...
    treasure: 'Ember coins', hazard: 'Lava', title: 'titles/title-challenges.png',
  ...
  ice: {
    ...
    treasure: 'Frost coins', hazard: 'Freezing water', title: 'titles/title-world.png',
  ...
  castle: {
    ...
    treasure: 'Royal coins', hazard: 'Castle moat', title: 'titles/title-brain.png',
  ...
  canopy: {
    ...
    treasure: 'Amber coins', hazard: 'Forest river', title: 'titles/title-knowledge.png',
  ...
  village: {
    ...
    treasure: 'Copper coins', hazard: 'Harbour water', title: 'titles/title-tech.png',
