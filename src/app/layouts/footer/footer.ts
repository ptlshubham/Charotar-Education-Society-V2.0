import { Component, ViewEncapsulation, signal, inject, Inject, PLATFORM_ID } from '@angular/core';
...
export class Footer {
  ...
  readonly socials: ReadonlyArray<{ name: string; icon: string; link: string }> = [
    ...
    { name: 'Facebook', icon: 'facebook', link: 'https://www.facebook.com/people/ZarklyX/61585022711713/' },
    { name: 'YouTube', icon: 'youtube', link: 'https://www.youtube.com/@Zarkly-X' },
    { name: 'X', icon: 'x', link: 'https://x.com/ZarklyX' },
    { name: 'Reddit', icon: 'reddit', link: 'https://www.reddit.com/user/zarklyx_/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button' },
  ...
  sections = signal<NavSection[]>([
    {
      ...
      items: ['About ZarklyX', 'Teams', 'Careers', 'Customers', 'Pricing', 'Trust Center', 'Contact Us'],
      open: false,
    },
    {
      title: 'Modules', icon: 'grid',
      items: [
        'Token System', 'Social Media Management', 'Employee Management',
        'Finance & Accounting', 'HRMS', 'CRM', 'Payroll', 'Influencer Management',
      ],
      open: false,
    },
    {
      ...
      items: [
        'Facebook', 'Instagram', 'X (Twitter)', 'LinkedIn', 'Threads',
        'Pinterest', 'Google Drive', 'Dropbox', 'All Integrations',
      ],
      open: false,
    },
    {
      ...
      items: [
        ...
        'Social Media Management', 'Social Insights', 'Brand Awareness', 'Industries',
      ],
      open: false,
    },
    {
      title: 'Resources', icon: 'book',
      items: ['Blogs', 'Newsroom', 'Podcast', 'Tutorials', 'Help Center', 'Community', 'Expert Sessions'],
      open: false,
    },
    {
      title: 'Support', icon: 'headset',
      items: ['System Status', 'FAQs', 'Report Abuse', 'Feature Requests', 'Delete Account', 'Contact Support', 'Sitemap'],
      open: false,
    },
  ]);
