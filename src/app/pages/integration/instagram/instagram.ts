...
export class InstagramIntegration {
  ...
  readonly keyFeatures: ReadonlyArray<{
  ...
  }> = [
    {
      ...
      desc: 'Manage Instagram DMs and comments from your unified inbox.',
    },
    {
      icon: 'calendar',
      color: '#3DAFA9',
      title: 'Content Scheduling',
      desc: 'Schedule posts, Reels, and Stories at the perfect time.',
    },
    {
      icon: 'chart',
      color: '#3772FF',
      title: 'Advanced Analytics',
      desc: 'Track engagement, reach, impressions, and audience growth.',
    },
    {
      icon: 'users',
      color: '#E8A33D',
      title: 'Audience Insights',
      desc: 'Get deep insights into your audience and their behavior.',
    },
    {
      icon: 'image',
      color: '#3772FF',
      title: 'Media Management',
      desc: 'Organize and manage all your media assets in one place.',
    },
    {
      icon: 'bookmark',
      color: '#F17C9F',
      title: 'Hashtag & Caption Suggestions',
      desc: 'Get AI-powered suggestions to boost your content performance.',
    },
  ];
  ...
  readonly howItWorks: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    {
      icon: 'link',
      title: 'Connect',
      desc: 'Authorize your Instagram Business or Creator Account.',
    },
    {
      icon: 'sync',
      title: 'Select Assets',
      desc: 'Choose the Instagram account and assets you want to sync.',
    },
    { icon: 'gear', title: 'Configure', desc: 'Set permissions and map data to start syncing.' },
    {
      icon: 'refresh',
      title: 'Sync Data',
      desc: "We'll sync your messages, comments, and insights in real-time.",
    },
    {
      icon: 'chart',
      title: 'Take Action',
      desc: 'Manage, engage, and grow your Instagram presence from ZarklyX.',
    },
  ];
  ...
  readonly useCases: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    {
      ...
      desc: 'Collaborate with influencers and track campaign performance.',
    },
    {
      icon: 'chat',
      title: 'Customer Support',
      desc: 'Respond to DMs and comments quickly to improve customer experience.',
    },
    {
      icon: 'play',
      title: 'Content Creators',
      desc: 'Manage content, track analytics, and grow your community easily.',
    },
    {
      icon: 'cart',
      title: 'E-commerce',
      desc: 'Promote products, drive traffic, and increase sales from Instagram.',
    },
    {
      icon: 'megaphone',
      title: 'Brand Building',
      desc: 'Build brand awareness and engage your audience effectively.',
    },
  ];
  ...
  readonly requirements = [
    ...
    'Facebook Page connected (optional)',
    'Internet connection',
  ];
