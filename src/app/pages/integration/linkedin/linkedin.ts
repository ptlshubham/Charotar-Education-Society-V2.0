...
export class LinkedinIntegration {
  ...
  readonly keyFeatures: ReadonlyArray<{
  ...
  }> = [
    {
      ...
      desc: 'Schedule posts, articles, and updates at the best time for your audience.',
    },
    {
      icon: 'chat',
      color: '#3DAFA9',
      title: 'Company Page Management',
      desc: 'Manage your LinkedIn Company Page posts and settings in one place.',
    },
    {
      icon: 'users',
      color: '#C587CE',
      title: 'Lead Generation',
      desc: 'Capture leads from LinkedIn and automatically sync to your CRM.',
    },
    {
      icon: 'chart',
      color: '#E8A33D',
      title: 'Analytics & Reporting',
      desc: 'Track impressions, clicks, engagement, and follower growth.',
    },
    {
      icon: 'doc',
      color: '#3DAFA9',
      title: 'Content Management',
      desc: 'Create, organize, and repurpose content that drives engagement.',
    },
    {
      icon: 'hash',
      color: '#3772FF',
      title: 'Employee Advocacy',
      desc: 'Empower your team to share content and expand your reach.',
    },
  ];
  ...
  readonly howItWorks: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    { icon: 'plug', title: 'Connect', desc: 'Connect your LinkedIn Company Page securely.' },
    {
      ...
      desc: 'Choose page, set permissions and configure preferences.',
    },
    {
      icon: 'sync',
      title: 'Sync Data',
      desc: "We'll sync your content, leads, and analytics in real-time.",
    },
    {
      icon: 'calendar',
      title: 'Take Action',
      desc: 'Schedule posts, engage with your audience, and capture quality leads.',
    },
    {
      icon: 'chart',
      title: 'Measure & Grow',
      desc: 'Track performance and grow your professional presence.',
    },
  ];
  ...
  readonly useCases: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    {
      icon: 'megaphone',
      title: 'B2B Marketing',
      desc: 'Share thought leadership content and generate high-quality leads.',
    },
    {
      icon: 'headset',
      title: 'Recruitment',
      desc: 'Attract top talent and manage job postings efficiently.',
    },
    {
      icon: 'image',
      title: 'Brand Visibility',
      desc: 'Increase brand awareness through consistent company updates.',
    },
    {
      icon: 'calendar',
      title: 'Event Promotion',
      desc: 'Promote webinars, events and create more registrations.',
    },
    {
      icon: 'user',
      title: 'Thought Leadership',
      desc: 'Publish articles and position your brand as an industry leader.',
    },
  ];
