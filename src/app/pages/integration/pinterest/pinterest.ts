...
export class PinterestIntegration {
  ...
  readonly keyFeatures: ReadonlyArray<{
  ...
  }> = [
    {
      ...
      desc: 'Create and schedule Pins at the best time to maximize reach and engagement.',
    },
    {
      icon: 'folder',
      color: '#E8A33D',
      title: 'Board Management',
      desc: 'Manage your Pinterest boards directly from ZarklyX.',
    },
    {
      icon: 'chart',
      color: '#C587CE',
      title: 'Rich Analytics',
      desc: 'Track impressions, saves, clicks, engagements, and audience insights.',
    },
    {
      icon: 'trend',
      color: '#3DAFA9',
      title: 'Traffic & Conversions',
      desc: 'Drive more traffic to your website and measure conversion impact.',
    },
    {
      icon: 'compass',
      color: '#3772FF',
      title: 'Content Discovery',
      desc: 'Discover trending ideas and content to keep your audience inspired.',
    },
    {
      icon: 'team',
      color: '#F17C9F',
      title: 'Team Collaboration',
      desc: 'Collaborate with your team to plan, create, and publish content.',
    },
  ];
  ...
  readonly howItWorks: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    {
      icon: 'plug',
      title: 'Connect',
      desc: 'Connect your Pinterest Business account with ZarklyX securely.',
    },
    {
      icon: 'sliders',
      title: 'Select & Configure',
      desc: 'Choose boards, set preferences, and configure your content strategy.',
    },
    {
      icon: 'sync',
      title: 'Sync Data',
      desc: "We'll sync your boards, Pins, and analytics in real-time.",
    },
    {
      icon: 'calendar',
      title: 'Schedule & Publish',
      desc: 'Create and schedule Pins at the best time to engage your audience.',
    },
    {
      icon: 'chart',
      title: 'Analyze & Optimize',
      desc: 'Track performance, gain insights, and optimize your Pinterest strategy.',
    },
  ];
  ...
  readonly useCases: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    {
      ...
      desc: 'Share inspiring content and drive more traffic to your blog or website.',
    },
    {
      icon: 'cart',
      title: 'E-commerce',
      desc: 'Promote products and boost catalog visibility with shoppable Pins.',
    },
    {
      icon: 'flag',
      title: 'Brand Awareness',
      desc: 'Build brand presence and engage new audiences consistently.',
    },
    {
      icon: 'chart',
      title: 'Lead Generation',
      desc: 'Drive targeted traffic and capture quality leads from Pinterest.',
    },
    {
      icon: 'image',
      title: 'Event Promotion',
      desc: 'Promote events, webinars, and launches with eye-catching Pins.',
    },
  ];
  ...
  readonly requirements = [
    ...
    'Pinterest API Access (via Developer Account)',
    'Internet connection',
  ];
