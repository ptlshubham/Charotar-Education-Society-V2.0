...
export class XTwitterIntegration {
  ...
  readonly keyFeatures: ReadonlyArray<{
  ...
  }> = [
    {
      ...
      desc: 'Schedule tweets in advance and maintain a consistent presence.',
    },
    {
      icon: 'chat',
      color: '#3DAFA9',
      title: 'Direct Messages',
      desc: 'Manage and reply to DMs from your unified inbox.',
    },
    {
      icon: 'heart',
      color: '#F17C9F',
      title: 'Engagement Management',
      desc: 'Like, reply, retweet, and engage with your audience easily.',
    },
    {
      icon: 'chart',
      color: '#C587CE',
      title: 'Analytics & Insights',
      desc: 'Track impressions, engagements, and audience growth.',
    },
    {
      icon: 'users',
      color: '#E8A33D',
      title: 'Audience Growth',
      desc: 'Understand your audience and grow your followers.',
    },
    {
      icon: 'hash',
      color: '#3DAFA9',
      title: 'Hashtag & Trend Tracking',
      desc: 'Track top trends and hashtags to stay ahead.',
    },
  ];
  ...
  readonly howItWorks: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    { icon: 'plug', title: 'Connect', desc: 'Connect your X (Twitter) account securely.' },
    {
      ...
      desc: 'Choose accounts and configure preferences.',
    },
    {
      icon: 'sync',
      title: 'Sync Data',
      desc: "We'll sync your tweets, followers, and data in real-time.",
    },
    {
      icon: 'calendar',
      title: 'Take Action',
      desc: 'Schedule tweets, engage with your audience, and manage everything.',
    },
    {
      icon: 'chart',
      title: 'Measure & Grow',
      desc: 'Track performance and optimize your social media strategy.',
    },
  ];
  ...
  readonly useCases: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    {
      ...
      desc: 'Promote your brand and campaigns effectively.',
    },
    {
      icon: 'headset',
      title: 'Customer Support',
      desc: 'Respond to queries and engage with customers in real-time.',
    },
    {
      icon: 'calendar',
      title: 'Content Promotion',
      desc: 'Schedule and promote content to drive more traffic.',
    },
    {
      icon: 'chart',
      title: 'Lead Generation',
      desc: 'Use tweets and campaigns to generate quality leads.',
    },
    {
      icon: 'users',
      title: 'Community Building',
      desc: 'Engage with your audience and build a loyal community.',
    },
  ];
