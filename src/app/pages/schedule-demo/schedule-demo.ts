...
interface Step { n: number; title: string; desc: string; }
interface Reason { icon: string; title: string; desc: string; }
...
export class ScheduleDemo {
  ...
  // ─── Demo request form ───
  readonly countries = ['India', 'United States', 'United Kingdom', 'United Arab Emirates', 'Australia', 'Canada', 'Singapore', 'Germany', 'Other'];

  readonly form = {
    workEmail: '', firstName: '', lastName: '', company: '', phone: '',
    jobFunction: '', jobLevel: '', country: 'India', consent: true,
  };
  ...
  submitDemo(formValid: boolean): void {
    ...
    this.resourcesService.submitScheduleDemo({
  ...
  readonly capabilities: Capability[] = [
    { icon: 'agency', title: 'Agency Management', desc: 'Manage clients, teams and projects in one place.' },
    { icon: 'automation', title: 'Workflow Automation', desc: 'Automate repetitive tasks and save time.' },
    { icon: 'billing', title: 'Billing & Invoicing', desc: 'Create invoices, track payments and get paid.' },
    { icon: 'chart', title: 'Reports & Analytics', desc: 'Get real-time insights and make data-driven decisions.' },
  ...
  readonly whyChoose: Reason[] = [
    { icon: 'grid', title: 'All-in-One Platform', desc: 'Everything you need to run your business.' },
    ...
    { icon: 'headset', title: 'Dedicated Support', desc: '24/7 expert support whenever you need it.' },
  ];
  ...
  readonly earlyAccessPerks: Reason[] = [
    { icon: 'unlock', title: 'Every module unlocked', desc: 'CRM, social scheduling, projects, HR, payroll and invoicing. The full platform during your trial, not a cut-down tier.' },
    { icon: 'headset', title: 'Hands-on onboarding', desc: 'We help you move your clients across and set your workspace up properly, at no cost.' },
    { icon: 'bolt', title: 'Shape what we build', desc: 'Early agencies get direct input into the roadmap and priority on the features they need most.' },
  ];
  ...
  // ─── FAQ ───
  readonly faqs: Faq[] = [
    { q: 'What is ZarklyX?', a: 'ZarklyX is an all-in-one business management platform that helps agencies and businesses manage clients, automate workflows, handle billing, and collaborate  all from one place.', open: false },
    { q: 'How does the free trial work?', a: 'You get full access to ZarklyX for 14 days. Explore every feature and cancel anytime before the trial ends.', open: false },
    { q: 'Can I upgrade or downgrade my plan?', a: 'Yes. You can change your plan at any time from your account settings  upgrades apply instantly and downgrades take effect at the next billing cycle.', open: false },
    { q: 'Is my data secure with ZarklyX?', a: 'Absolutely. We use enterprise-grade encryption, secure data centers, and follow industry best practices to keep your data safe.', open: false },
    { q: 'Can I integrate ZarklyX with other tools?', a: 'Yes. ZarklyX integrates with popular tools across social media, cloud storage, analytics, CRM and more  with new integrations added regularly.', open: false },
  ];
  ...
  // ─── Support ───
  readonly supportItems = ['24/7 Email Support', 'Live Chat Support', 'Help Center & Documentation', 'Video Tutorials'];
