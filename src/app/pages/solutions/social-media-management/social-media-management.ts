  ...
  readonly features: ReadonlyArray<{ icon: string; title: string; desc: string }> = [
    {
      ...
      desc: 'Plan your content calendar, organize campaigns, and never miss a post.',
    },
    {
      icon: 'pen',
      title: 'Create & Customize',
      desc: 'Design stunning posts with built-in editor, templates, and AI assistance.',
    },
    {
      icon: 'send',
      title: 'Publish & Schedule',
      desc: 'Schedule posts for the best time and publish across multiple platforms.',
    },
    {
      icon: 'chat',
      title: 'Engage & Respond',
      desc: 'Manage all messages, comments, and mentions from one unified inbox.',
    },
    {
      icon: 'chart',
      title: 'Analytics & Reports',
      desc: 'Track performance, measure ROI, and get actionable insights.',
    },
    {
      icon: 'team',
      title: 'Team Collaboration',
      desc: 'Collaborate with your team, assign roles, and streamline approvals.',
    },
  ];
